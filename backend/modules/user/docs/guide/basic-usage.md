...
'modules' => [
    ...
    'admin' => [
        ...
        'controllerMap' => [
            'assignment' => [
                'class' => 'backend\modules\user\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `backend\modules\user\components\AccessControl`:

```php
'as access' => [
    'class' => 'backend\modules\user\components\AccessControl',
    'allowActions' => [
        'site/login', 
        'site/error',
    ]
